-- Entry point for the MiniAurasVoicePackTrump test suite. Run from the repository root:
--
...
io.write("MiniAurasVoicePackTrump - unit tests\n")
io.write("=====================================\n")

local testFiles = {
	"tests/TestSmoke.lua",
	"tests/TestRegistration.lua",
}
